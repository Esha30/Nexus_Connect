    ...
    <>
      ...
      {!isOpen && !isDocked && (
        <button
          ...
          className={`fixed top-20 left-4 md:top-auto md:bottom-6 md:left-auto md:right-6 w-10 h-10 bg-gray-900 text-white rounded-full shadow-xl hover:bg-gray-800 hover:scale-110 z-50 group flex items-center justify-center animate-fade-in ${
        ...
        >
          ...
          <Sparkles size={20} className="relative z-10 text-primary-400 group-hover:text-primary-300" />
        </button>
      )}
